 ...
 * one 0..1 score axis:
 *
 *   weak   ○ hollow, indigo    (above the axis)
 *   strong ● filled, vermilion (below the axis)
 *
      ...
      {full && (
        <div className="mb-3 flex items-end justify-between gap-3">
          ...
          <div className="text-center">
            <div className="faceplate mb-1">Δ mean</div>
            <div className="headline tnum text-xl leading-none text-foreground">
        ...
        <div className="relative h-full w-full">
          ...
          {empty && (
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="faceplate">awaiting rollouts</span>
            </div>
          )}
        </div>
      </div>
      ...
      {full && (
        <>
          ...
          <div className="mt-3 border-t pt-3">
            {separation == null ? (
              <p className="faceplate text-center">separation pending</p>
            ) : (
              <div className="flex items-baseline gap-2">
                <span className="faceplate shrink-0 text-foreground">
