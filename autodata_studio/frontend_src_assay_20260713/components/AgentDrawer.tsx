  ...
  return (
    <div className="overflow-hidden rounded-md border">
      <div className="flex items-center gap-2 border-b bg-muted/40 px-3 py-2">
        ...
        <span className={cn("faceplate ml-auto text-current", decisionColor)}>{r.decision}</span>
      </div>
      ...
      <div className="space-y-3 p-3 text-sm">
        {agent === "challenger" && (
          <>
            ...
            <div className="faceplate">rubric · {r.challenger?.rubric?.length || 0} criteria</div>
          </>
        )}
...
function KV({ k, v }: { k: string; v: any }) {
  ...
  return (
    <div>
      <div className="faceplate mb-1">{k}</div>
