...
ICONQA_PROMPTS: dict[str, PromptSpec] = {
    ...
    "fraction": PromptSpec(
        ...
        "in the options. Every supplied attachment must participate in at least one substantive "
        "ratio comparison in the stem or options; never silently omit an image. Limit the solution "
        "to two arithmetic/comparison steps. Every fraction "
